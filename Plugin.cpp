...
constexpr PresetValue rubberBass[] {
    ...
    { mno::MNOParameter::osc1PWMRate, 0.72 },
    { mno::MNOParameter::osc1PWMDepth, 16 },
    { mno::MNOParameter::osc2PWMRate, 0.72 },
    { mno::MNOParameter::osc2PWMDepth, -12 },
...
constexpr PresetValue slowBloom[] {
    ...
    { mno::MNOParameter::osc1PWMRate, 0.09 },
    { mno::MNOParameter::osc1PWMDepth, 7 },
    { mno::MNOParameter::osc2PWMRate, 0.09 },
    { mno::MNOParameter::osc2PWMDepth, -5 },
